...
\noindent
\textbf{To do:} Develop Uppaal models as requested, and write a report using LaTeX. This report should include screenshots of the requested time automata and properties that you verify, and an explanation of the architectural scenario used for Exercise 3.
\\
\textbf{To submit:} The report in PDF \textbf{and} developed Uppaal models.
\\
\textbf{To demo:} The result of Exercise 3.
\\
\textbf{Deadline:} 21 April 2016
