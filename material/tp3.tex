...
\noindent
\textbf{To do:} Develop Reo models as requested, and write a report using LaTeX. This report should visual representations of the requested connectors and properties that you verify, and an explanation of the architectural scenario (and variations) used for Exercise~\ref{ex:demo}.
\\
\textbf{To submit:} The report in PDF.
\\
\textbf{To demo:} The result of Exercise~\ref{ex:demo}.
\\
\textbf{Deadline:} 19 May 2016
